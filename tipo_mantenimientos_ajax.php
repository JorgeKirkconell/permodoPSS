...
if(isset($_GET['guardar'])){
  ...
  //echo $query;
    ...
    if($ultimo>0){
      ...
      registra_vitacora("Guardar", "Tipo Mantenimiento", $ultimo, $usuarioc);
//}
?>
  	<?php echo $mensaje;?>
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-example-wrap mg-t-30">
                            <div class="cmp-tb-hd cmp-int-hd">
                                <h2>Tipos de mantenimiento del sistema</h2>
                            </div>
                            ...
                            <div class="form-example-int form-horizental mg-t-15">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="nk-int-st">
                                                <input type="text" id="descripcion" name="descripcion" class="form-control input-sm" placeholder="Descripcion adicional del tipo de mantenimiento" value="<?php echo $datos->descripcion;?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
if(isset($_GET['actualizar'])){
  ...
  //echo $query;
    ...
    if($filas>0){
      ...
      registra_vitacora("Actualizar", "Tipo Mantenimiento", $nid, $usuarioc);
//}
?>
...
if(isset($_GET['activar'])){
	...
	$query->execute();
      ...
      registra_vitacora("Activar", "Tipo Mantenimiento", $nid, $usuarioc);
//}
?>
 <div class="container-fluid py-4">  
  <?php echo $mensaje;?>
...
if(isset($_GET['desactivar'])){
  ...
  $datos = $query->fetch(PDO::FETCH_OBJ);
      ...
      $mensaje="<div class=\"alert alert-success\" role=\"alert\">
        ...
        registra_vitacora("Desactivar", "Tipo Mantenimiento", $nid, $usuarioc);
//}
?>
 <div class="container-fluid py-4">  
  <?php echo $mensaje;?>
...
if(isset($_GET['eliminar'])){
  ...
  //$datos = $query->fetch(PDO::FETCH_OBJ);
      ...
      //registra_vitacora("eliminar", "Tipo Mantenimiento", $id, $usuarioc);
      registra_vitacora("Eliminar", "Tipo Mantenimiento", $nid, $usuarioc);
