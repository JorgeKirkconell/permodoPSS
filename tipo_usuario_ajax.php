...
if(isset($_GET['guardar'])){
  ...
  $query = "INSERT INTO tipousuarios(nombreTipo, descripcion, activo, fechaCreacion, usuarioCreacion) values($nombreTipo, $descripcion, $activo, NOW(),'$usuarioc')";
  ...
  //echo $query;
    ...
    if($ultimo>0){
    	/*$query = $db->prepare("SELECT * from tipousuarios where id = '$ultimo';");
    	$query->execute();
    	$datos = $query->fetch(PDO::FETCH_OBJ);*/
    	$mensaje="<div class=\"alert alert-success\" role=\"alert\">
      			      <strong>Exito!</strong> El registro de guardo sin problemas.
      			  </div>";
      registra_vitacora("Guardar", "Tipo Usuarios", $ultimo, $usuarioc);
//}
?>
  	<?php echo $mensaje;?>
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-example-wrap mg-t-30">
                            <div class="cmp-tb-hd cmp-int-hd">
                                <h2>Tipos de Usuarios del Sistema</h2>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="normal-table-list">
                            <div class="basic-tb-hd">
                                <h2>Tipos de Usuarios Creados</h2>
                                <p>Tipos de Usuarios creados en el Sistema al día de hoy</p>
                            </div>
                            <div class="bsc-tbl">
                                <table class="table table-sc-ex table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                            $consulta = "SELECT * FROM tipousuarios";
                                            //echo $consulta;
...
if(isset($_GET['editar'])){
	...
	$query = $db->prepare("SELECT * from tipousuarios where id = $id;");
	$query->execute();
	$datos = $query->fetch(PDO::FETCH_OBJ);
//}
?>
...
if(isset($_GET['actualizar'])){
  ...
  //echo $query;
    ...
    if($filas>0){
      ...
      registra_vitacora("Actualizar", "Tipo Usuarios", $nid, $usuarioc);
//}
?>
...
if(isset($_GET['activar'])){
	...
	$id = $db->quote($_GET['id']);$usuarioc = $_SESSION['id'];
    $nid = ($_GET['id']);
	$query = $db->prepare("UPDATE tipousuarios set activo = 1 where id = $id;");
	$query->execute();

      $mensaje="<div class=\"alert alert-success\" role=\"alert\">
            <strong>Exito!</strong> El registro de activo sin problemas.
        </div>";
      registra_vitacora("Activar", "Tipo Usuarios", $nid, $usuarioc);
//}
?>
 <div class="container-fluid py-4">  
  <?php echo $mensaje;?>
...
if(isset($_GET['desactivar'])){
  ...
  $id = $db->quote($_GET['id']);$usuarioc = $_SESSION['id'];
  $nid = ($_GET['id']);
  $query = $db->prepare("UPDATE tipousuarios set activo = 2 where id = $id;");
  $query->execute();
  $query = $db->prepare("SELECT * FROM tipousuarios where id = $id;");
  $query->execute();
  $datos = $query->fetch(PDO::FETCH_OBJ);
      ...
      registra_vitacora("Desactivar", "Tipo Usuarios", $nid, $usuarioc);
//}
?>
 <div class="container-fluid py-4">  
  <?php echo $mensaje;?>
...
if(isset($_GET['eliminar'])){
  ...
  $id = $db->quote($_GET['id']);$usuarioc = $_SESSION['id'];
  $nid = ($_GET['id']);
  $query = $db->prepare("DELETE FROM tipousuarios where id = $id;");
  $query->execute();
  //$datos = $query->fetch(PDO::FETCH_OBJ);
      ...
      registra_vitacora("Eliminar", "Tipo Usuarios", $nid, $usuarioc);
//}
?>
 <div class="container-fluid py-4">
  <?php echo $mensaje;?>
